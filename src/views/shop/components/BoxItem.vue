...
const level = {
  1: {
    color: "#f2a105",
    background:
      "https://cfcfcs.oss-cn-beijing.aliyuncs.com/static/oss6d005153def8488687142e9affe0f156黄的_20250412192110A035.png",
  },
  2: {
    color: "#FC7F53",
    background:
      "https://cfcfcs.oss-cn-beijing.aliyuncs.com/static/osscb46671391254998a8284904ca205eeb红色_20250412192118A036.png",
  },
  3: {
    color: "#B26DFF",
    background:
      "https://cfcfcs.oss-cn-beijing.aliyuncs.com/static/ossbaeec2f95e37499b960c52080b0a1402紫色_20250412192130A037.png",
  },
  4: {
    color: "#4589FF",
    background:
      "https://cfcfcs.oss-cn-beijing.aliyuncs.com/static/osseb77eeb679a742d1b96270171ec7ca62蓝色_20250412192148A038.png",
  },
};
...
<template>
  ...
  >
    ...
    <div
      v-if="boxUser.id"
      :class="{ 'tw-opacity-100': hover, 'tw-rounded': props.isRound }"
    ...
    <div
      ...
      class="tw-text-sm tw-text-center tw-px-3 tw-py-2"
    >
